  ...
  <body class="p-3 mb-2 bg-light text-dark"><br><br>
    ...
    <div class="card" style="width: 27.5rem;">
        <div class="card-body">
          ...
          <form class="row g-3 needs-validation" id="database" action="<?php echo base_url('/RS/succes') ?>" method="POST" novalidate>
            <div class="col-md-4">
              <label for="validationCustom01" class="form-label">Username</label>
              <input type="text" class="form-control" id="validationCustom01" required name="namaPengguna">
